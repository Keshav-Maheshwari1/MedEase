          ...
          <form action="" onSubmit={handleUserRegister} className='main-register-entry'>
            ...
            <div className="user-password register">
              <input
                ...
                required
              />
              <button type='button' onClick={handleShowPassword} id='register-eye'>{showPassword ? <img src="https://cdn-icons-png.flaticon.com/128/4855/4855030.png" alt="Hide" /> : <img src="https://cdn-icons-png.flaticon.com/128/11502/11502607.png" alt="Show" />}</button>
            </div>
